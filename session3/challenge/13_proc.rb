...
def your_sort(array, &orderer)
  ...
  array.each_index do |index1|
    array.each_index do |index2|
      order = orderer.call(array[index1], array[inedx2])
      array[index1], array[index2] = array[index2], array[index1], array[index1] if order < 0
    end
  end
end

####did not understand this solution!!!!!
